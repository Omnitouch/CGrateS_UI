            ...
            <Form>
                <Row>
                    ...
                    <Col md={6} className="d-flex align-items-end">
                        <AccountDropdown cgratesConfig={cgratesConfig} onSelect={setAccount} />
                    </Col>
                </Row>
                <Row className="mt-3">
                    <Col md={4}>
                        <Form.Group>
                            ...
                            <Form.Control as="select" value={direction} onChange={(e) => setDirection(e.target.value)}>
                    ...
                    <Col md={4}>
                        <Form.Group>
                            ...
                            <Form.Control as="select" value={usage} onChange={(e) => setUsage(Number(e.target.value))}>
                                {usagePresets[category].map((val, idx) => (
                                    <option key={idx} value={val}>{val} ({usageLabels[category][idx]})</option>
                                ))}
                            </Form.Control>
                        </Form.Group>
                    </Col>
                    <Col md={4}>
                        <Form.Group>
                            ...
                            <Form.Control as="select" value={requestType} onChange={(e) => setRequestType(e.target.value)}>
                ...
                <Row className="mt-3">
                    <Col md={4}>
                        <Form.Group>
                            ...
                            <Form.Control as="select" value={category} onChange={(e) => handleCategoryChange(e.target.value)}>
                    ...
                    <Col md={4}>
                        <Form.Group>
                            ...
                            <Form.Control as="select" value={tor} onChange={(e) => setTor(e.target.value)}>
                                <option value="*sms">*sms</option>
                                <option value="*data">*data</option>
                                <option value="*call">*call</option>
                            </Form.Control>
